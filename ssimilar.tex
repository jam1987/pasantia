...
\end{itemize}
	...
	Dentro de las herramientas m'as utilizadas en \textbf{ABAP/4}, est'an los smartforms. En la siguiente subsecci'on se explicar'a m'as a detalle acerca de dicha herramienta.
	
\subsection{Smartforms}
